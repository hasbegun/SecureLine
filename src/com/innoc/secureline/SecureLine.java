...
import com.innoc.secureline.directory.DirectoryUpdateReceiver;
import com.innoc.secureline.ui.CallControls;
import com.innoc.secureline.ui.CallScreen;
import com.innoc.secureline.util.AudioUtils;
import com.innoc.secureline.util.PeriodicActionUtils;
 ...
 *
 */
public class SecureLine extends Activity {
    static {
        Security.addProvider(new org.spongycastle.jce.provider.BouncyCastleProvider());
    }

    private static final String TAG = SecureLine.class.getName();
    ...
    private SecureLineService secureLineService;
  ...
  private void startServiceIfNecessary() {
    ...
    {
      Log.w(TAG, "Calling startService from within RedPhone!");
      String number = Uri.decode(intent.getData().getEncodedSchemeSpecificPart());
      Intent serviceIntent = new Intent();
      serviceIntent.setClass(this, SecureLineService.class);
  ...
  private void initializeServiceBinding() {
    ...
    Intent bindIntent = new Intent(this, SecureLineService.class);
  ...
  private void handleSetMute(boolean enabled) {
    Intent intent = new Intent(this, SecureLineService.class);
    intent.setAction(SecureLineService.ACTION_SET_MUTE);
  ...
  private void handleAnswerCall() {
    ...
    callScreen.setActiveCall(secureLineService.getRemotePersonInfo(),
                             getString(R.string.RedPhone_answering));

    Intent intent = new Intent(this, SecureLineService.class);
    intent.setAction(SecureLineService.ACTION_ANSWER_CALL);
    startService(intent);
  }
  ...
  private void handleDenyCall() {
    ...
    Intent intent = new Intent(this, SecureLineService.class);
    intent.setAction(SecureLineService.ACTION_DENY_CALL);
    startService(intent);
  ...
  private void handleCallConnected(SASInfo sas) {
    ...
    secureLineService.notifyCallConnectionUIUpdateComplete();
  }
...
//    debugCard.setInfo( info );
    ...
    if( msg != null && !isFinishing() ) {
      ...
      ad.setPositiveButton("Ok", new OnClickListener() {
        public void onClick(DialogInterface dialog, int arg) {
          SecureLine.this.handleTerminate(LOCAL_TERMINATE);
        }
      });
      ad.show();
    }
  ...
  private void handleNoSuchUser(final String user) {
    ...
    dialog.setPositiveButton(R.string.RedPhone_yes_exclamation, new OnClickListener() {
      public void onClick(DialogInterface dialog, int arg) {
        SecureLine.this.sendInstallLink(user);
        SecureLine.this.handleTerminate(LOCAL_TERMINATE);
      }
    });
  ...
  private class ConfirmSasButtonListener implements CallControls.ConfirmSasButtonListener {
    public void onClick() {
      Intent intent = new Intent(SecureLine.this, SecureLineService.class);
      intent.setAction(SecureLineService.ACTION_CONFIRM_SAS);
      startService(intent);
    }
  }
  ...
  private class HangupButtonListener implements CallControls.HangupButtonListener {
    public void onClick() {
      ...
      Intent intent = new Intent(SecureLine.this, SecureLineService.class);
      intent.setAction(SecureLineService.ACTION_HANGUP_CALL);
      startService(intent);
  ...
  private class MuteButtonListener implements CallControls.MuteButtonListener {
    ...
    public void onToggle(boolean isMuted) {
      SecureLine.this.handleSetMute(isMuted);
    }
  }
  ...
  private class AudioButtonListener implements CallControls.AudioButtonListener {
    ...
    public void onAudioChange(AudioUtils.AudioMode mode) {
      switch(mode) {
        case DEFAULT:
          AudioUtils.enableDefaultRouting(SecureLine.this);
          break;
        case SPEAKER:
          AudioUtils.enableSpeakerphoneRouting(SecureLine.this);
          break;
        case HEADSET:
          AudioUtils.enableBluetoothRouting(SecureLine.this);
          break;
        default:
  ...
  private class IncomingCallActionListener implements CallControls.IncomingCallActionListener {
    ...
    public void onAcceptClick() {
      SecureLine.this.handleAnswerCall();
    }
    @Override
    public void onDenyClick() {
      SecureLine.this.handleDenyCall();
    }
  }

  private ServiceConnection serviceConnection = new ServiceConnection() {
    public void onServiceConnected(ComponentName className, IBinder service) {
      SecureLine.this.secureLineService  = ((SecureLineService.SecureLineServiceBinder)service).getService();
      secureLineService.setCallStateHandler(callStateHandler);

      PersonInfo personInfo = secureLineService.getRemotePersonInfo();

      switch (secureLineService.getState()) {
      ...
      case STATE_CONNECTED: handleCallConnected(secureLineService.getCurrentCallSAS()); break;
      }
    }

    public void onServiceDisconnected(ComponentName name) {
      secureLineService.setCallStateHandler(null);
    }
  };
