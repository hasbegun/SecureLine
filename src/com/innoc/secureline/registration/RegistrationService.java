package com.innoc.secureline.registration;
...
import com.innoc.secureline.SecureLineService;
import com.innoc.secureline.directory.DirectoryUpdateReceiver;
import com.innoc.secureline.directory.NumberFilter;
...
import com.innoc.secureline.signaling.DirectoryResponse;
import com.innoc.secureline.signaling.RateLimitExceededException;
import com.innoc.secureline.signaling.SignalingException;
import com.innoc.secureline.ui.AccountVerificationTimeoutException;
...
public class RegistrationService extends Service {
  ...
  private void handleVoiceRegistrationIntent(Intent intent) {
    ...
    try {
      ...
      stopService(new Intent(this, SecureLineService.class));
