...
import com.innoc.secureline.crypto.EncryptedSignalMessage;
import com.innoc.secureline.crypto.InvalidEncryptedSignalException;
import com.innoc.secureline.signaling.SessionDescriptor;
import com.innoc.secureline.signaling.signals.CompressedInitiateSignalProtocol.CompressedInitiateSignal;
import com.innoc.secureline.sms.IncomingCallDetails;
...
public class GCMIntentService extends GCMBaseIntentService {
  ...
  protected void onMessage(Context context, Intent intent) {
    ...
    if (callDetails != null) {
      intent.setClass(context, SecureLineService.class);
      intent.setAction(SecureLineService.ACTION_INCOMING_CALL);
