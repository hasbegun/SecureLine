...
import com.innoc.secureline.registration.RegistrationService;
import com.innoc.secureline.signaling.AccountCreationException;
import com.innoc.secureline.signaling.AccountCreationSocket;
import com.innoc.secureline.signaling.RateLimitExceededException;
import com.innoc.secureline.signaling.SignalingException;
import com.innoc.secureline.util.PhoneNumberFormatter;
import com.innoc.secureline.util.Util;
...
public class RegistrationProgressActivity extends SherlockActivity {
  ...
  private void handleVerificationRequestedVoice(RegistrationService.RegistrationState state) {
  ...
  private void handleConnectivityError(RegistrationService.RegistrationState state) {
    this.registrationLayout.setVisibility(View.GONE);
    this.verificationFailureLayout.setVisibility(View.GONE);
  ...
  private void handleTimerUpdate() {
    ...
    registrationStateHandler.sendEmptyMessageDelayed(RegistrationService.RegistrationState.STATE_TIMER, 1000);
  }
  ...
  private class RegistrationServiceConnection implements ServiceConnection {
    ...
    public void onServiceConnected(ComponentName className, IBinder service) {
      ...
      RegistrationService.RegistrationState state = registrationService.getRegistrationState();
  ...
  private class RegistrationStateHandler extends Handler {
    ...
    public void handleMessage(Message message) {
      ...
      case RegistrationService.RegistrationState.STATE_VERIFYING_SMS:   handleStateVerifyingSms();               break;
      case RegistrationService.RegistrationState.STATE_VERIFYING_VOICE: handleStateVerifyingVoice();             break;
