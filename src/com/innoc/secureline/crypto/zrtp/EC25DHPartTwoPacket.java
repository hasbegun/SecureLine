...
import com.innoc.secureline.network.RtpPacket;
...
public class EC25DHPartTwoPacket extends DHPartTwoPacket {
  ...
  public EC25DHPartTwoPacket(RtpPacket packet) {
    super(packet, EC25_AGREEMENT_TYPE);
  }

  public EC25DHPartTwoPacket(RtpPacket packet, boolean deepCopy) {
    super(packet, EC25_AGREEMENT_TYPE, deepCopy);
  }
  ...
  {
    super(EC25_AGREEMENT_TYPE, hashChain, pvr, retainedSecrets, includeLegacyHeaderBug);
